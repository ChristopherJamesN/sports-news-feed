...
const NewsShow = ({ newsItem }) =>
  <div>
    ...
    <br></br>
    <ListGroup>
        <ListGroupItem><h3> {newsItem.title} </h3></ListGroupItem>
    </ListGroup>
    <ListGroup>
        <ListGroupItem><p>{newsItem.description}</p></ListGroupItem>
    </ListGroup>
    <ListGroup>
        <ListGroupItem><a href={newsItem.url} target="_blank">Link to Full Story</a></ListGroupItem>
    </ListGroup>
    <br></br>
    <div>
