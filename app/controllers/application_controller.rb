...
class ApplicationController < ActionController::Base
  ...
  def fetch_news_from_cache_or_api(search_term)
    ...
    excluded_domains = 'biztoc.com,dailycaller.com,rlsbb.ru,thefutoncritic.com,drunkenstepfather.com,egotasticsports.com,zacjohnson.com,smartbitchestrashybooks.com'
